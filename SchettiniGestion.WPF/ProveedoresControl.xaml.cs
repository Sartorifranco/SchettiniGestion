...
namespace SchettiniGestion.WPF
{
    public partial class ProveedoresControl : UserControl
    {
        ...
        private void CargarProveedores()
        {
            ...
            {
                ModernMessageBox.Show($"Error al cargar proveedores: {ex.Message}", "Error", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private void btnGuardar_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                ModernMessageBox.Show("El CUIT y la Razón Social son obligatorios.", "Datos Incompletos", MessageBoxButton.OK, MessageBoxImage.Warning);
                return;
            }
            ...
            if (exito)
            {
                ModernMessageBox.Show("Proveedor guardado exitosamente.", "Éxito", MessageBoxButton.OK, MessageBoxImage.Information);
                CargarProveedores();
                LimpiarCampos();
            }
        }
        ...
        private void btnEliminar_Click(object sender, RoutedEventArgs e)
        {
            ...
            // Confirmación
            MessageBoxResult confirmacion = ModernMessageBox.Show($"¿Está seguro de que desea eliminar al proveedor '{txtRazonSocial.Text}'?",
            ...
            if (confirmacion == MessageBoxResult.Yes)
            {
                ...
                if (exito)
                {
                    ModernMessageBox.Show("Proveedor eliminado exitosamente.", "Éxito", MessageBoxButton.OK, MessageBoxImage.Information);
                    CargarProveedores();
                    LimpiarCampos();
                }
            }
