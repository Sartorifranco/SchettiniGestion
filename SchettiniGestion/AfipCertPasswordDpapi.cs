...
namespace SchettiniGestion
{
    ...
    /// (<see cref="ProtectedData"/>), vinculada al usuario de Windows actual.
    ...
    internal static class AfipCertPasswordDpapi
    {
        ...
        /// <summary>Devuelve la contraseña en claro desde el valor persistido.</summary>
        public static string Decode(string storedFromDb)
        {
            ...
            if (!storedFromDb.StartsWith(Prefix, StringComparison.Ordinal))
                return storedFromDb; // legado en claro en la BD
